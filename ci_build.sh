...
java -jar zipsigner-3.0.jar UPDATE-AnyKernel3.zip Sunscape-$BUILD_ID.zip
BUILD_END=$(date +"%s")
DIFF=$((BUILD_END - BUILD_START))
tg_post_build "Sunscape-$BUILD_ID.zip" "Build took : $((DIFF / 60)) minute(s) and $((DIFF % 60)) second(s)"